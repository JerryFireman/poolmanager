...
Development plan 
1) UI: bind tests, rebind, unbind, swap fee, public, status (token, contract balance, allowance, bound balance, denormalized weight, normalized weight), security check, approval test for smart contract
